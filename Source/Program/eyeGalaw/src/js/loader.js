...
getObjectdata( function(data){
	...
	if (data["starting-page"] == true) string = "<div class=\"loader\">\n<img src=\"chrome-extension://"+myid+"/src/img/dots.png\" id=\"dots-line\" >\n\n  \n\n\t<div id=\"marks\"></div>\n\t\n</div>";
	else 		string = "<div class=\"loader\"  style=\"background-image: url(chrome-extension://"+myid+"/src/img/load.gif);\" >\t</div>";
